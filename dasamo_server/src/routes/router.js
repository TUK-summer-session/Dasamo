...
router.post('/api/reviews/questions/:reviewId', apiReviewController.storeComment);
router.delete('/api/reviews/questions/:questionId', apiReviewController.deleteComment);
